	...
	Def.Sprite {
		...
		Def.Sprite {
			OnCommand=function (self)
				...
				(cmd(diffusealpha,0;scaletoclipped,460,460;zoom,4;sleep,1.455;linear,0.15;diffusealpha,0.5;zoom,0.75;linear,0.1;zoom,1;linear,0.3;diffusealpha,0;zoom,1.4;sleep,6))(self)
			end;
			end;
	};
};
