...
t[#t+1] = Def.ActorFrame{
  InitCommand=cmd(draworder,200;xy,SCREEN_CENTER_X,SCREEN_CENTER_Y+240);
  LoadActor(THEME:GetPathG("","_sharedX2/_selectarrowg")) .. {
    InitCommand=cmd(x,-286;diffusealpha,0);
  ...
  LoadActor(THEME:GetPathG("","_sharedX2/_selectarrowg")) .. {
    InitCommand=cmd(x,286;zoomx,-1;zoomy,1;diffusealpha,0);
    OnCommand=cmd(sleep,0.5;smooth,0.3;diffusealpha,1;);
    OffCommand=cmd(smooth,0.2;addx,50;diffusealpha,0;);
